...
export default function PricingPage() {
  ...
  const getAnnualPrice = (monthlyUsdPrice: number) => {
    const annualUsdPrice = monthlyUsdPrice * 12 * 0.8 // 20% discount
    if (language === 'en') {
  ...
  const features: PricingFeature[] = [
    { title: 'AI 生成額度/月', essential: '200 次', pro: '700 次', unlimited: '無限制', enterprise: '無限制' },
    { title: '視頻生成額度/月', essential: '100 次', pro: '300 次', unlimited: '無限制', enterprise: '無限制' },
    { title: '專案數量上限', essential: '20 個', pro: '50 個', unlimited: '無限制', enterprise: '無限制' },
    { title: '自訂角色數量', essential: '2 個', pro: '5 個', unlimited: '10 個', enterprise: '無限制' },
    { title: '場景數量/專案', essential: '20 個', pro: '100 個', unlimited: '200+ 個', enterprise: '無限制' },
    { title: 'ZIP 匯出', essential: false, pro: true, unlimited: true, enterprise: true },
    { title: 'AI 配音功能', essential: false, pro: true, unlimited: true, enterprise: true },
    { title: '視頻匯出', essential: false, pro: false, unlimited: true, enterprise: true },
    { title: '團隊成員數', essential: '1 人', pro: '5 人', unlimited: '10 人', enterprise: '無限制' },
    { title: '專屬客服支援', essential: false, pro: false, unlimited: false, enterprise: true },
  ]
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 hover:shadow-xl transition-shadow border border-gray-100">
              <div className="text-center mb-8">
                ...
                <div className="text-3xl font-bold mb-2">
                  {isAnnual ? getAnnualPrice(29) : getPriceDisplay(29)}
                  <span className="text-base font-normal text-gray-500">/{language === 'en' ? 'mo' : '月'}</span>
                </div>
                {isAnnual && (
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 hover:shadow-xl transition-shadow border border-gray-100">
              <div className="text-center mb-8">
                ...
                <div className="text-3xl font-bold mb-2">
                  {isAnnual ? getAnnualPrice(59) : getPriceDisplay(59)}
                  <span className="text-base font-normal text-gray-500">/{language === 'en' ? 'mo' : '月'}</span>
                </div>
                {isAnnual && (
                  <div className="text-sm text-gray-500">{language === 'en' ? 'Billed annually' : '年付優惠'}</div>
            ...
            <div className="bg-gradient-to-b from-[#1E1B4B]/5 to-white rounded-xl shadow-lg p-8 hover:shadow-xl transition-shadow border-2 border-[#1E1B4B]">
              ...
              <div className="text-center mb-8">
                ...
                <div className="text-3xl font-bold mb-2">
                  {isAnnual ? getAnnualPrice(119) : getPriceDisplay(119)}
                  <span className="text-base font-normal text-gray-500">/{language === 'en' ? 'mo' : '月'}</span>
                </div>
                {isAnnual && (
                  <div className="text-sm text-gray-500">{language === 'en' ? 'Billed annually' : '年付優惠'}</div>
